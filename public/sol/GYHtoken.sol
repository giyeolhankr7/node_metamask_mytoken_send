...
contract GYHCoin is StandardToken { // CHANGE THIS. Update the contract name.
    ...
    */
    ...
    function GYHCoin() {
        ...
        name = "GYHCoin";                                   // Set the name for display purposes (CHANGE THIS)
        decimals = 18;                                               // Amount of decimals for display purposes (CHANGE THIS)
        symbol = "GYH";                                             // Set the symbol for display purposes (CHANGE THIS)
